...
// const result=categories.map(c=>({value:c,label:c.split('-').join(" "),checked:false,section:'category'}))
// console.log(result)
...
const filterProducts=products.products.map((item)=>{const {id,...rest}=item;return rest})
console.log(filterProducts)

// const filter={"brand":'Apple','category':"smartphones"}
// const sort={"sort":"price","order":"desc"}
